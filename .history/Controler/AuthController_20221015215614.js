...
exports.deleteUser = (async (req, res, next) => {
  try {
   let if_containe_product=  await Product.findByIdAndDelete({user: req.params.id});
  let if_containe_excercise= await Excercise.findByIdAndDelete({user:req.params.id});
